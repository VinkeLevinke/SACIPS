...
$tipoOperacion = $formData['tipo_operacion']; // Agregar esta línea para recibir el tipo de operación
    ...
    <div class="cuadroFormulario">
        <form action="./componentes/afiliados/procesarPago.php" id="formularioAfiliados" method="POST" enctype="multipart/form-data">
            <div class="btnVolver">
                ...
                <input onclick="confirm('¿Seguro que desea salir?')" class="link-btn" type="button" id="btnVolverRecibo" value="volver" hidden>
            </div>
